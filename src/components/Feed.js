...
class Feed extends Component {
  ...
  _handleInitiateChat = (e) => {
    ...
    const data = {
      currentUserId: this.state.userId.toString(),
    ...
    return (
      <div className="main">
          ...
          <Container>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
              <Nav className="mx-auto">
                ...
                <NavLink
                  id="profileLink"
                  className="profileLink navLinks me-2"
                  to="/profile"
                >
                  Near Me
                </NavLink>
        ...
        <div className="mainHeading">
          <span id="DEVTitle">Dev</span>
          <span id="PlatformTitle">Platform</span>
        </div>
          ...
          {this.state.matchedUsers.map((user) => {
            ...
            return (
              <Card key={user.id} className="card">
                ...
                <Button id={user.id} onClick={this._handleInitiateChat}>
                  Chat
                </Button>
              </Card>
            );
